...
Plan, nog niet gebouwd. Kleine UX-correctie, gesignaleerd door de
gebruiker: sommige `omschrijving`-teksten zijn erg lang, wat de
resultatenlijst (niet het detailpaneel) onoverzichtelijk maakt.
