...
| `/api/rce/concept` | Eén Referentienetwerk-query | Browser 300 seconden, gedeeld 3.600 seconden | Geen limiter; exacte URI, lange cache en beperkte querykosten |
| `/api/rce/complex-members` | Eén begrensde detailquery | Browser 60 seconden, gedeeld 300 seconden | Geen limiter; exacte CHO-URI en alleen op detailinteractie |
| `/api/rce/onderzoeksgebied-verrijking` | Drie begrensde detailquery's | Browser 60 seconden, gedeeld 300 seconden | Geen limiter; exacte CHO-URI en alleen op detailinteractie |
| `/api/rce/vondstlocatie-inhoud` | Twee begrensde detailquery's plus resolutie van gevonden concepten | Browser 60 seconden, gedeeld 300 seconden | Geen limiter; exacte CHO-URI en alleen op detailinteractie |
