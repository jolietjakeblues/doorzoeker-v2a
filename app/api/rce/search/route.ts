...
export async function GET(request: Request) {
  ...
  try {
    ...
    const browse = browseParam === "rijksmonument" || browseParam === "archeologischterrein" || browseParam === "onderzoeksgebied" || browseParam === "vondstlocatie" || browseParam === "archeologischcomplex" || browseParam === "werelderfgoed" || browseParam === "gezicht" || browseParam === "complex" ? browseParam : undefined;
    ...
    const isPagedBrowse = browse === "rijksmonument" || browse === "archeologischterrein" || browse === "onderzoeksgebied" || browse === "vondstlocatie" || browse === "archeologischcomplex";
    const pageSize = 25;
