...
function toItem(record: RceMonument, term: string): Item {
  ...
  return {
    ...
    registrationDate: record.registrationDate, official: true, sourceUrl: record.monumentNumber ? `${MONUMENT_REGISTER_BASE_URL}${encodeURIComponent(record.monumentNumber)}` : record.sourceUrl, wkt: record.wkt,
    parcels: record.parcels, matchSource: record.matchSource, matchedText, matchScore: record.matchScore,
